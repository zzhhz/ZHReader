...
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerGridItemDecoration(Context context) {
        ...
        mHorizontalDivider = mDivider = a.getDrawable(0);
        a.recycle();
    }

    public DividerGridItemDecoration(int color) {
        mHorizontalDivider = mDivider = new ColorDrawable(color);
    }

    public void setHorizontalDivider(Drawable mHorizontalDivider) {
        if (mHorizontalDivider == null) {
            this.mHorizontalDivider = mDivider;
        } else {
